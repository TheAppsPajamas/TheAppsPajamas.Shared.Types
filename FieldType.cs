...
namespace DAL.Enums
{
    public class FieldType : Enumeration<FieldType>
    {
        ...
        public static readonly AppIconFieldType AppIconSharedMaster
            = new AppIconFieldType.Shared(-1, "Shared master app icon", true, 10, false, null, 1024);

        public static readonly AppIconFieldType AppIconDroidMaster
            = new AppIconFieldType.Droid(-5, "Droid master app icon", true, 10, false, null, 1024);
        public static readonly AppIconFieldType AppIconDroidPlaystore
            = new AppIconFieldType.Droid(-6, "Droid playstore app icon", false, 20, false, null, 1024);
        public static readonly AppIconFieldType AppIconDroidLdpi
            = new AppIconFieldType.Droid(-7, "Droid ldpi app icon", false, 30, true, new Dictionary<string, string> { { "folder", "mipmap-ldpi" } }, 36);
        public static readonly AppIconFieldType AppIconDroidMdpi
            = new AppIconFieldType.Droid(-8, "Droid mdpi app icon", false, 40, true, new Dictionary<string, string> { { "folder", "mipmap-mdpi" } }, 48);
        public static readonly AppIconFieldType AppIconDroidHdpi
        = new AppIconFieldType.Droid(-9, "Droid hdpi app icon", false, 50, true, new Dictionary<string, string> { { "folder", "mipmap-hdpi" } }, 72);
        public static readonly AppIconFieldType AppIconDroidXhdpi
        = new AppIconFieldType.Droid(-10, "Droid xhdpi app icon", false, 60, true, new Dictionary<string, string> { { "folder", "mipmap-xhdpi" } }, 96);
        public static readonly AppIconFieldType AppIconDroidXxhdpi
        = new AppIconFieldType.Droid(-11, "Droid xxhdpi app icon", false, 70, true, new Dictionary<string, string> { { "folder", "mipmap-xxhdpi" } }, 144);
        public static readonly AppIconFieldType AppIconDroidXxxhdpi
        = new AppIconFieldType.Droid(-12, "Droid xxxhdpi app icon", false, 80, true, new Dictionary<string, string> { { "folder", "mipmap-xxxhdpi" } }, 192);

        public static readonly AppIconFieldType AppIconIosMaster
        = new AppIconFieldType.Ios(-15, "Ios master app icon", true, 10, false, null, 1024);

        public static readonly AppIconFieldType AppIconIosITunesArtwork
            = new AppIconFieldType.Ios(-16, "Ios iTunesArtwork", false, 20, true
        ...
        public static readonly AppIconFieldType AppIconIosITunesArtwork_2x
            = new AppIconFieldType.Ios(-17, "Ios iTunesArtwork@2x", false, 30, true
        ...
        public static readonly AppIconFieldType AppIconIosMarketingIcon
            = new AppIconFieldType.Ios(-18, "Ios marketing icon", false, 40, true
        ...
        public static readonly AppIconFieldType AppIconIosIcon20_1x
            = new AppIconFieldType.Ios(-19, "Ios icon-20@1x", false, 50, true
                , new Dictionary<string, string>{
                                        {"size", "20x20"},
                                        {"idiom", "ipad"},
                                        {"scale", "1x"},
        ...
        public static readonly AppIconFieldType AppIconIosIcon20_2x
            = new AppIconFieldType.Ios(-20, "Ios icon-20@2x", false, 60, true
                , new Dictionary<string, string>{
                                        {"size", "20x20"},
                                        {"idiom", "iphone"},
                                        {"idiom2", "ipad"},
        ...
        public static readonly AppIconFieldType AppIconIosIcon60_2x
            = new AppIconFieldType.Ios(-22, "Ios icon-60@2x", false, 80, true
                , new Dictionary<string, string>{
                                        {"size", "60x60"},
                                        {"idiom", "iphone"},
                                        {"scale", "2x"},
        ...
        public static readonly AppIconFieldType AppIconIosIcon60_3x
            = new AppIconFieldType.Ios(-23, "Ios icon-60@3x", false, 90, true
                , new Dictionary<string, string>{
                                        {"size", "60x60"},
                                        {"idiom", "iphone"},
                                        {"scale", "3x"},
        ...
        public static readonly AppIconFieldType AppIconIosIcon76
            = new AppIconFieldType.Ios(-24, "Ios icon-76", false, 100, true
                , new Dictionary<string, string>{
                                        {"size", "76x76"},
                                        {"idiom", "ipad"},
                                        {"scale", "1x"},
        ...
        public static readonly AppIconFieldType AppIconIosIcon76_2x
            = new AppIconFieldType.Ios(-25, "Ios icon-76@2x", false, 110, true
                , new Dictionary<string, string>{
                                        {"size", "76x76"},
                                        {"idiom", "ipad"},
                                        {"scale", "2x"},
        ...
        public static readonly AppIconFieldType AppIconIosIcon83_5_2x
            = new AppIconFieldType.Ios(-26, "Ios icon-83.5@2x", false, 120, true
                , new Dictionary<string, string>{
                                        {"size", "83.5x83.5"},
                                        {"idiom", "ipad"},
                                        {"scale", "2x"},
        ...
        public static readonly AppIconFieldType AppIconIosIconSmall40
            = new AppIconFieldType.Ios(-27, "Ios icon-small-40", false, 130, true
                , new Dictionary<string, string>{
                                        {"size", "40x40"},
                                        {"idiom", "ipad"},
                                        {"scale", "1x"},
        ...
        public static readonly AppIconFieldType AppIconIosIconSmall40_2x
            = new AppIconFieldType.Ios(-28, "Ios icon-small-40@2x", false, 140, true
                , new Dictionary<string, string>{
                                        {"size", "40x40"},
                                        {"idiom", "iphone"},
                                        {"scale", "2x"},
        ...
        public static readonly AppIconFieldType AppIconIosIconSmall40_3x
            = new AppIconFieldType.Ios(-29, "Ios icon-small-40@3x", false, 150, true
                , new Dictionary<string, string>{
                                        {"size", "40x40"},
                                        {"idiom", "iphone"},
                                        {"scale", "3x"},
        ...
        public static readonly AppIconFieldType AppIconIosIconSmall
            = new AppIconFieldType.Ios(-30, "Ios icon-small", false, 160, true
                , new Dictionary<string, string>{
                                        {"size", "29x29"},
                                        {"idiom", "ipad"},
                                        {"scale", "1x"},
        ...
        public static readonly AppIconFieldType AppIconIosIconSmall_2x
            = new AppIconFieldType.Ios(-31, "Ios icon-small@2x", false, 170, true
                                   , new Dictionary<string, string>{
                                        {"size", "29x29"},
                                        {"idiom", "iphone"},
                                        {"scale", "2x"},
        ...
        public static readonly AppIconFieldType AppIconIosIconSmall_3x
            = new AppIconFieldType.Ios(-32, "Ios icon-small@3x", false, 180, true
                , new Dictionary<string, string>{
                                        {"size", "29x29"},
                                        {"idiom", "iphone"},
                                        {"scale", "3x"},
        ...
        public static PackagingFieldType PackagingSharedName
            = new PackagingFieldType(-50, "Shared name", ProjectType.Shared, true, 10, false, StringFieldDisplayType.Text);
        public static PackagingFieldType PackagingSharedIdentifier
            = new PackagingFieldType(-51, "Shared identifier", ProjectType.Shared, true, 20, false, StringFieldDisplayType.Text);
        public static PackagingFieldType PackagingSharedVersionText
            = new PackagingFieldType(-52, "Shared version", ProjectType.Shared, true, 30, false, StringFieldDisplayType.Text);
        public static PackagingFieldType PackagingSharedVersionNumber
            = new PackagingFieldType(-53, "Shared version number", ProjectType.Shared, true, 40, false, StringFieldDisplayType.Number);


        public static PackagingFieldType PackagingDroidName
            = new PackagingFieldType(-54, "Droid name", ProjectType.Droid, true, 10, true, StringFieldDisplayType.Text);
        public static PackagingFieldType PackagingDroidIdentifier
            = new PackagingFieldType(-55, "Droid identifier", ProjectType.Droid, true, 20, true, StringFieldDisplayType.Text);
        public static PackagingFieldType PackagingDroidVersionText
            = new PackagingFieldType(-56, "Droid version", ProjectType.Droid, true, 30, true, StringFieldDisplayType.Text);
        public static PackagingFieldType PackagingDroidVersionNumber
            = new PackagingFieldType(-57, "Droid version number", ProjectType.Droid, true, 40, true, StringFieldDisplayType.Number);
        public static PackagingFieldType PackagingDroidAppIconName
            = new PackagingFieldType(-63, "Droid app icon name", ProjectType.Droid, false, 50, true, StringFieldDisplayType.Text);
        public static PackagingFieldType PackagingDroidSplashName
            = new PackagingFieldType(-64, "Droid splash image name", ProjectType.Droid, false, 60, true, StringFieldDisplayType.Text);

        public static PackagingFieldType PackagingIosName
            = new PackagingFieldType(-58, "Ios name", ProjectType.Ios, true, 10, true, StringFieldDisplayType.Text);
        public static PackagingFieldType PackagingIosIdentifier
            = new PackagingFieldType(-59, "Ios identifier", ProjectType.Ios, true, 20, true, StringFieldDisplayType.Text);
        public static PackagingFieldType PackagingIosVersionText
            = new PackagingFieldType(-60, "Ios version", ProjectType.Ios, true, 30, true, StringFieldDisplayType.Text);
        public static PackagingFieldType PackagingIosVersionNumber
            = new PackagingFieldType(-61, "Ios version number", ProjectType.Ios, true, 40, true, StringFieldDisplayType.Number);
        public static PackagingFieldType PackagingIosAssetCatalogueName
            = new PackagingFieldType(-67, "Ios asset catalogue name", ProjectType.Ios, false, 50, true, StringFieldDisplayType.Text);
        public static PackagingFieldType PackagingIosAppIconXcAssetsName
            = new PackagingFieldType(-65, "Ios app icon xcassets name", ProjectType.Ios, false, 60, true, StringFieldDisplayType.Text);
        public static PackagingFieldType PackagingIosLaunchImageXcAssetsName
            = new PackagingFieldType(-66, "Ios launch image xcassets name", ProjectType.Ios, false, 70, true, StringFieldDisplayType.Text);
        public static PackagingFieldType PackagingIosUsesNonExemptEncryption
            = new PackagingFieldType(-62, "Ios uses non exempt encryption", ProjectType.Ios, false, 80, true, StringFieldDisplayType.Bool);


        public static BuildConfigRecordSetType BuildConfigFieldSetCompilerConstants
            = new BuildConfigRecordSetType(-70, "Compiler constants", ProjectType.Shared, 10, true, StringFieldDisplayType.Text);

        //splash
        public static readonly SplashFieldType SplashSharedMaster
            = new SplashFieldType.Shared(-80, "Shared master splash screen", true, 10, false, null, 2048, 2048);

        public static readonly SplashFieldType SplashDroidMaster
            = new SplashFieldType.Droid(-85, "Droid master splash screen", true, 10, false, null, 2048, 2048);

        public static readonly SplashFieldType SplashIosMaster
            = new SplashFieldType.Ios(-125, "Ios master splash screen", true, 10, false, null, 2048, 2048);
