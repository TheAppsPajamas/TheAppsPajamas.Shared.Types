...
namespace TheAppsPajamas.Shared.Types
{
    public class FieldType : Enumeration<FieldType, string>
    {
        ...
        public static readonly AppIconFieldType AppIconSharedMaster
            = new AppIconFieldType.Shared("1", "Shared master app icon", AppIconFieldVersionType.Version1, 10, false, true, false, null, null, 1024);

        #endregion

        #region AppIconDroid
        public static readonly AppIconFieldType AppIconDroidMaster
            = new AppIconFieldType.Droid("100", "Droid master app icon", AppIconFieldVersionType.Version1, 10, false, true, false, AppIconSharedMaster, null, 1024);
        public static readonly AppIconFieldType AppIconDroidPlaystore
            = new AppIconFieldType.Droid("105", "Droid playstore app icon", AppIconFieldVersionType.Version1, 20, false, true, false, AppIconDroidMaster, null, 1024);
        public static readonly AppIconFieldType AppIconDroidLdpi
            = new AppIconFieldType.Droid("110", "Droid ldpi app icon", AppIconFieldVersionType.Version1, 30, true, true, false, AppIconDroidMaster
                , new Dictionary<string, string> { { "folder", "mipmap-ldpi" } }, 36);
        public static readonly AppIconFieldType AppIconDroidMdpi
            = new AppIconFieldType.Droid("115", "Droid mdpi app icon", AppIconFieldVersionType.Version1, 40, true, true, false, AppIconDroidMaster
                , new Dictionary<string, string> { { "folder", "mipmap-mdpi" } }, 48);
        public static readonly AppIconFieldType AppIconDroidHdpi
        = new AppIconFieldType.Droid("120", "Droid hdpi app icon", AppIconFieldVersionType.Version1, 50, true, true, false, AppIconDroidMaster
            , new Dictionary<string, string> { { "folder", "mipmap-hdpi" } }, 72);
        public static readonly AppIconFieldType AppIconDroidXhdpi
        = new AppIconFieldType.Droid("125", "Droid xhdpi app icon", AppIconFieldVersionType.Version1, 60, true, true, false, AppIconDroidMaster
            , new Dictionary<string, string> { { "folder", "mipmap-xhdpi" } }, 96);
        public static readonly AppIconFieldType AppIconDroidXxhdpi
        = new AppIconFieldType.Droid("130", "Droid xxhdpi app icon", AppIconFieldVersionType.Version1, 70, true, true, false, AppIconDroidMaster
            , new Dictionary<string, string> { { "folder", "mipmap-xxhdpi" } }, 144);
        public static readonly AppIconFieldType AppIconDroidXxxhdpi
        = new AppIconFieldType.Droid("135", "Droid xxxhdpi app icon", AppIconFieldVersionType.Version1, 80, true, true, false, AppIconDroidMaster
        ...
        = new AppIconFieldType.Ios("200", "Ios master app icon", AppIconFieldVersionType.Version1, 10, false, true, false, AppIconSharedMaster, null, 1024);

        public static readonly AppIconFieldType AppIconIosITunesArtwork
            = new AppIconFieldType.Ios("205", "Ios iTunesArtwork", AppIconFieldVersionType.Version1, 20, true, true, false, AppIconIosMaster
        ...
        public static readonly AppIconFieldType AppIconIosITunesArtwork_2x
            = new AppIconFieldType.Ios("210", "Ios iTunesArtwork@2x", AppIconFieldVersionType.Version1, 30, true, true, false, AppIconIosMaster
        ...
        public static readonly AppIconFieldType AppIconIosMarketingIcon
            = new AppIconFieldType.Ios("215", "Ios marketing icon", AppIconFieldVersionType.Version1, 40, true, true, false, AppIconIosMaster
        ...
        public static readonly AppIconFieldType AppIconIosIcon20_1x
            = new AppIconFieldType.Ios("220", "Ios icon-20@1x", AppIconFieldVersionType.Version1, 50, true, true, false, AppIconIosMaster
                , new Dictionary<string, string>{
                                        {"size", "20x20"},
                                        {"idiom", "ipad"},
                                        {"scale", "1x"},
        ...
        public static readonly AppIconFieldType AppIconIosIcon20_2x
            = new AppIconFieldType.Ios("225", "Ios icon-20@2x", AppIconFieldVersionType.Version1, 60, true, true, false, AppIconIosMaster
                , new Dictionary<string, string>{
                                        {"size", "20x20"},
                                        {"idiom", "iphone"},
                                        {"idiom2", "ipad"},
        ...
        public static readonly AppIconFieldType AppIconIosIcon20_3x
            = new AppIconFieldType.Ios("230", "Ios icon-20@3x", AppIconFieldVersionType.Version1, 70, true, true, false, AppIconIosMaster
                , new Dictionary<string, string>{
                                        {"size", "20x20"},
                                        {"idiom", "iphone"},
                                        {"scale", "3x"},
        ...
        public static readonly AppIconFieldType AppIconIosIcon60_2x
            = new AppIconFieldType.Ios("235", "Ios icon-60@2x", AppIconFieldVersionType.Version1, 80, true, true, false, AppIconIosMaster
                , new Dictionary<string, string>{
                                        {"size", "60x60"},
                                        {"idiom", "iphone"},
                                        {"scale", "2x"},
        ...
        public static readonly AppIconFieldType AppIconIosIcon60_3x
            = new AppIconFieldType.Ios("240", "Ios icon-60@3x", AppIconFieldVersionType.Version1, 90, true, true, false, AppIconIosMaster
                , new Dictionary<string, string>{
                                        {"size", "60x60"},
                                        {"idiom", "iphone"},
                                        {"scale", "3x"},
        ...
        public static readonly AppIconFieldType AppIconIosIcon76
            = new AppIconFieldType.Ios("245", "Ios icon-76", AppIconFieldVersionType.Version1, 100, true, true, false, AppIconIosMaster
                , new Dictionary<string, string>{
                                        {"size", "76x76"},
                                        {"idiom", "ipad"},
                                        {"scale", "1x"},
        ...
        public static readonly AppIconFieldType AppIconIosIcon76_2x
            = new AppIconFieldType.Ios("250", "Ios icon-76@2x", AppIconFieldVersionType.Version1, 110, true, true, false, AppIconIosMaster
                , new Dictionary<string, string>{
                                        {"size", "76x76"},
                                        {"idiom", "ipad"},
                                        {"scale", "2x"},
        ...
        public static readonly AppIconFieldType AppIconIosIcon83_5_2x
            = new AppIconFieldType.Ios("255", "Ios icon-83.5@2x", AppIconFieldVersionType.Version1, 120, true, true, false, AppIconIosMaster
                , new Dictionary<string, string>{
                                        {"size", "83.5x83.5"},
                                        {"idiom", "ipad"},
                                        {"scale", "2x"},
        ...
        public static readonly AppIconFieldType AppIconIosIconSmall40
            = new AppIconFieldType.Ios("260", "Ios icon-small-40", AppIconFieldVersionType.Version1, 130, true, true, false, AppIconIosMaster
                , new Dictionary<string, string>{
                                        {"size", "40x40"},
                                        {"idiom", "ipad"},
                                        {"scale", "1x"},
        ...
        public static readonly AppIconFieldType AppIconIosIconSmall40_2x
            = new AppIconFieldType.Ios("265", "Ios icon-small-40@2x", AppIconFieldVersionType.Version1, 140, true, true, false, AppIconIosMaster
                , new Dictionary<string, string>{
                                        {"size", "40x40"},
                                        {"idiom", "iphone"},
                                        {"scale", "2x"},
        ...
        public static readonly AppIconFieldType AppIconIosIconSmall40_3x
            = new AppIconFieldType.Ios("270", "Ios icon-small-40@3x", AppIconFieldVersionType.Version1, 150, true, true, false, AppIconIosMaster
                , new Dictionary<string, string>{
                                        {"size", "40x40"},
                                        {"idiom", "iphone"},
                                        {"scale", "3x"},
        ...
        public static readonly AppIconFieldType AppIconIosIconSmall
            = new AppIconFieldType.Ios("275", "Ios icon-small", AppIconFieldVersionType.Version1, 160, true, true, false, AppIconIosMaster
                , new Dictionary<string, string>{
                                        {"size", "29x29"},
                                        {"idiom", "ipad"},
                                        {"scale", "1x"},
        ...
        public static readonly AppIconFieldType AppIconIosIconSmall_2x
            = new AppIconFieldType.Ios("280", "Ios icon-small@2x", AppIconFieldVersionType.Version1, 170, true, true, false, AppIconIosMaster
                                   , new Dictionary<string, string>{
                                        {"size", "29x29"},
                                        {"idiom", "iphone"},
                                        {"scale", "2x"},
        ...
        public static readonly AppIconFieldType AppIconIosIconSmall_3x
            = new AppIconFieldType.Ios("285", "Ios icon-small@3x", AppIconFieldVersionType.Version1, 180, true, true, false, AppIconIosMaster
                , new Dictionary<string, string>{
                                        {"size", "29x29"},
                                        {"idiom", "iphone"},
                                        {"scale", "3x"},
        ...
        public static readonly AppIconFieldType AppIconIosAppIcon40x40_2x
            = new AppIconFieldType.Ios("300", "Ios icon-watch-40@2x", AppIconFieldVersionType.Version1, 190, true, true, false, AppIconIosMaster
                , new Dictionary<string, string>{
                                        {"size", "40x40"},
                                        {"idiom", "watch"},
                                        {"scale", "2x"},
        ...
        public static readonly AppIconFieldType AppIconIosAppIcon44x44_2x
            = new AppIconFieldType.Ios("305", "Ios icon-watch-44@2x", AppIconFieldVersionType.Version1, 200, true, true, false, AppIconIosMaster
                , new Dictionary<string, string>{
                                        {"size", "44x44"},
                                        {"idiom", "watch"},
                                        {"scale", "2x"},
        ...
        public static readonly AppIconFieldType AppIconIosAppIcon86x86_2x
            = new AppIconFieldType.Ios("310", "Ios icon-watch-86@2x", AppIconFieldVersionType.Version1, 210, true, true, false, AppIconIosMaster
                , new Dictionary<string, string>{
                                        {"size", "86x86"},
                                        {"idiom", "watch"},
                                        {"scale", "2x"},
        ...
        public static readonly AppIconFieldType AppIconIosAppIcon98x98_2x
            = new AppIconFieldType.Ios("315", "Ios icon-watch-98@2x", AppIconFieldVersionType.Version1, 220, true, true, false, AppIconIosMaster
                , new Dictionary<string, string>{
                                        {"size", "98x98"},
                                        {"idiom", "watch"},
                                        {"scale", "2x"},
        ...
        public static readonly AppIconFieldType AppIconIosAppIcon24x24_2x
            = new AppIconFieldType.Ios("320", "Ios icon-watch-24@2x", AppIconFieldVersionType.Version1, 230, true, true, false, AppIconIosMaster
                                   , new Dictionary<string, string>{
                                        {"size", "24x24"},
                                        {"idiom", "watch"},
                                        {"scale", "2x"},
        ...
        public static readonly AppIconFieldType AppIcon27_5x27_5_2x
            = new AppIconFieldType.Ios("325", "Ios icon-watch-27-5@2x", AppIconFieldVersionType.Version1, 240, true, true, false, AppIconIosMaster
                , new Dictionary<string, string>{
                                        {"size", "27.5x27.5"},
                                        {"idiom", "watch"},
                                        {"scale", "2x"},
        ...
        public static readonly AppIconFieldType AppIcon29x29_2x
            = new AppIconFieldType.Ios("330", "Ios icon-watch-29@2x", AppIconFieldVersionType.Version1, 250, true, true, false, AppIconIosMaster
                , new Dictionary<string, string>{
                                        {"size", "29x29"},
                                        {"idiom", "watch"},
                                        {"scale", "2x"},
        ...
        public static readonly AppIconFieldType AppIcon29x29_3x
            = new AppIconFieldType.Ios("335", "Ios icon-watch-29@3x", AppIconFieldVersionType.Version1, 260, true, true, false, AppIconIosMaster
                , new Dictionary<string, string>{
                                        {"size", "29x29"},
                                        {"idiom", "watch"},
                                        {"scale", "3x"},
        ...
        public static PackagingFieldType PackagingSharedName
            = new PackagingFieldType("1000", "Shared name", ProjectType.Shared, PackagingFieldVersionType.Version1, 10, false, true, false, null, StringFieldDisplayType.Text, String.Empty);
        public static PackagingFieldType PackagingSharedIdentifier
            = new PackagingFieldType("1005", "Shared identifier", ProjectType.Shared, PackagingFieldVersionType.Version1, 20, false, true, false, null, StringFieldDisplayType.Text, String.Empty);
        public static PackagingFieldType PackagingSharedVersionText
            = new PackagingFieldType("1010", "Shared version", ProjectType.Shared, PackagingFieldVersionType.Version1, 30, false, true, false, null, StringFieldDisplayType.Text, String.Empty);
        public static PackagingFieldType PackagingSharedVersionNumber
            = new PackagingFieldType("1015", "Shared version number", ProjectType.Shared, PackagingFieldVersionType.Version1, 40, false, true, false, null, StringFieldDisplayType.Number, String.Empty);


        public static PackagingFieldType PackagingDroidName
            = new PackagingFieldType("1100", "Droid name", ProjectType.Droid, PackagingFieldVersionType.Version1, 10, true, true, false, PackagingSharedName, StringFieldDisplayType.Text, String.Empty);
        public static PackagingFieldType PackagingDroidIdentifier
            = new PackagingFieldType("1105", "Droid identifier", ProjectType.Droid, PackagingFieldVersionType.Version1, 20, true, true, false, PackagingSharedIdentifier, StringFieldDisplayType.Text, String.Empty);
        public static PackagingFieldType PackagingDroidVersionText
            = new PackagingFieldType("1110", "Droid version", ProjectType.Droid, PackagingFieldVersionType.Version1, 30, true, true, false, PackagingSharedVersionText, StringFieldDisplayType.Text, String.Empty);
        public static PackagingFieldType PackagingDroidVersionNumber
            = new PackagingFieldType("1115", "Droid version number", ProjectType.Droid, PackagingFieldVersionType.Version1, 40, true, true, false, PackagingSharedVersionNumber, StringFieldDisplayType.Number, String.Empty);
        public static PackagingFieldType PackagingDroidAppIconName
            = new PackagingFieldType("1120", "Droid app icon name", ProjectType.Droid, PackagingFieldVersionType.Version1, 50, true, true, false, null, StringFieldDisplayType.Text, "ic_launcher");
        public static PackagingFieldType PackagingDroidSplashName
            = new PackagingFieldType("1125", "Droid splash image name", ProjectType.Droid, PackagingFieldVersionType.Version1, 60, true, true, false, null, StringFieldDisplayType.Text, "ic_splash");

        public static PackagingFieldType PackagingIosName
            = new PackagingFieldType("1200", "Ios name", ProjectType.Ios, PackagingFieldVersionType.Version1, 10, true, true, false, PackagingSharedName, StringFieldDisplayType.Text, String.Empty);
        public static PackagingFieldType PackagingIosIdentifier
            = new PackagingFieldType("1205", "Ios identifier", ProjectType.Ios, PackagingFieldVersionType.Version1, 20, true, true, false, PackagingSharedIdentifier, StringFieldDisplayType.Text, String.Empty);
        public static PackagingFieldType PackagingIosVersionText
            = new PackagingFieldType("1210", "Ios version", ProjectType.Ios, PackagingFieldVersionType.Version1, 30, true, true, false, PackagingSharedVersionText, StringFieldDisplayType.Text, String.Empty);
        public static PackagingFieldType PackagingIosVersionNumber
            = new PackagingFieldType("1215", "Ios version number", ProjectType.Ios, PackagingFieldVersionType.Version1, 40, true, true, false, PackagingSharedVersionNumber, StringFieldDisplayType.Number, String.Empty);
        public static PackagingFieldType PackagingIosAssetCatalogueName
            = new PackagingFieldType("1220", "Ios asset catalogue name", ProjectType.Ios, PackagingFieldVersionType.Version1, 50, true, true, false, null, StringFieldDisplayType.Text, "Tap");

        public static PackagingFieldType PackagingIosAppIconXcAssetsName
            = new PackagingFieldType("1225", "Ios app icon xcassets name", ProjectType.Ios, PackagingFieldVersionType.Version1, 60, true, true, false, null, StringFieldDisplayType.Text, "AppIcon");

        public static PackagingFieldType PackagingIosUseLaunchStoryboard
            = new PackagingFieldType("1230", "Ios use launch storyboard", ProjectType.Ios, PackagingFieldVersionType.Version1, 70, true, true, false, null, StringFieldDisplayType.Bool, "0");
        public static PackagingFieldType PackagingIosLaunchStoryboardName
            = new PackagingFieldType("1235", "Ios launch storyboard name", ProjectType.Ios, PackagingFieldVersionType.Version1, 80, true, true, false, null, StringFieldDisplayType.Text, "LaunchScreen");
        public static PackagingFieldType PackagingIosLaunchStoryboardPortraitXcAssetsName
            = new PackagingFieldType("1240", "Ios portrait launch storyboard xcassets name", ProjectType.Ios, PackagingFieldVersionType.Version1, 90, true, true, false, null, StringFieldDisplayType.Text, "LaunchScreenPortrait");
        public static PackagingFieldType PackagingIosLaunchStoryboardLandscapeXcAssetsName
            = new PackagingFieldType("1245", "Ios landscape launch storyboard xcassets name", ProjectType.Ios, PackagingFieldVersionType.Version1, 100, true, true, false, null, StringFieldDisplayType.Text, "LaunchScreenLandscape");
        public static PackagingFieldType PackagingIosLaunchImageXcAssetsName
            = new PackagingFieldType("1250", "Ios launch image xcassets name", ProjectType.Ios, PackagingFieldVersionType.Version1, 110, true, true, false, null, StringFieldDisplayType.Text, "Launch");
        public static PackagingFieldType PackagingIosUsesNonExemptEncryption
            = new PackagingFieldType("1255", "Ios uses non exempt encryption", ProjectType.Ios, PackagingFieldVersionType.Version1, 120, true, true, false, null, StringFieldDisplayType.Bool, "0");
        ...
        public static readonly SplashFieldType SplashSharedMaster
           = new SplashFieldType.Shared(value: "3000", displayName: "Shared master portrait splash screen"
                , fieldVersionType: SplashFieldVersionType.Version1
